...
// RESTfull route used by extractors to get video file if needed //NOT USED
...
// RESTfull route used by extractors to send us XML data
...
.put( function() {
  ...
  var old_xml_string = fs.readFileSync("/var/www/foat/project/"+this.params._id+"/annotation.xml","utf8");
  ...
  var dir = "/var/www/foat/project/"+this.params._id;
...
// RESTfull route used by extractors to send us the descriptor file for a specific version
...
.put( function() {
  ...
  var dir = "/var/www/foat/extractor/"+idExtractor;
